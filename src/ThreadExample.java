/*
 * This program illustrates the instantiation and running of threads by extending 
 * the Thread class instead of implementing the Runnable interface. To start 
 * the thread you need to invoke the start()method on your object.
 */
